    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                color.rgb = IN.texcoord.x > Remap(0, 1, .3, .7, _StirMinRange) && IN.texcoord.x < Remap(0, 1, .3, .7, _StirMaxRange) ? lerp(color, _StirColor, .5) : color.rgb;
